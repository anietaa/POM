...
public class BookAFlight {
	...
	boolean check_box_ticketless;
	boolean check_box_del_add;
	...
	public void enterDeliveryAddress(String dAdd1,String dAdd2,String dCity,String dState,String dZipCode,String dCounName) {
		//boolean check_box_del_add = driver.findElement(check_box_sameAsDeliveryAddress).isEnabled();
		    if(check_box_del_add != true || check_box_ticketless != true) {
			...
			delivery_Coun.selectByVisibleText(dCounName);
		    	 ...
		    	 clickOnCheckBox_Delivery_Address();
